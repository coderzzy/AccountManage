			...
			<tbody>
				...
				<%
					try {
						...
						String sql = "select *from account,platform,platform_account where platform.name= ? and platform_account.plat_id = platform.id and platform_account.account_id = account.id "
								+
